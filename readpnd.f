...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      character(len=100),dimension(100)::lid_lus
...
!! end .sfb file
	...
	backspace(104)
      ...
      !Bio-retentioncell
      read (104,*,iostat=eof) MLID_onoff(i,1)
      read (104,*,iostat=eof) LID_areaFr(i,1)
      read (104,*,iostat=eof) LR_fr(i,1)
      read (104,*,iostat=eof) LID_FB(i,1)
      read (104,*,iostat=eof) LID_VoidFr(i,1)
      read (104,*,iostat=eof) Lthik(i,1,1)
      read (104,*,iostat=eof) Lksat(i,1,1)
      read (104,*,iostat=eof) LmIni(i,1,1)
      read (104,*,iostat=eof) LmSat(i,1,1)
      read (104,*,iostat=eof) LsucH(i,1,1)
      read (104,*,iostat=eof) Lthta(i,1,1)
      read (104,*,iostat=eof) Lthik(i,1,2)
      read (104,*,iostat=eof) Lksat(i,1,2)
      read (104,*,iostat=eof) LmIni(i,1,2)
      read (104,*,iostat=eof) LmSat(i,1,2)
      read (104,*,iostat=eof) LsucH(i,1,2)
      read (104,*,iostat=eof) Lthta(i,1,2)
      read (104,*,iostat=eof) LD_drain(i,1)
      read (104,*,iostat=eof) LN_drain(i,1)
      read (104,*,iostat=eof) LD_height(i,1)
      !rain garden
      read (104,*,iostat=eof) MLID_onoff(i,2)
      read (104,*,iostat=eof) LID_areaFr(i,2)
      read (104,*,iostat=eof) LR_fr(i,2)
      read (104,*,iostat=eof) LID_FB(i,2)
      read (104,*,iostat=eof) LID_VoidFr(i,2)
      read (104,*,iostat=eof) Lthik(i,2,1)
      read (104,*,iostat=eof) Lksat(i,2,1)
      read (104,*,iostat=eof) LmIni(i,2,1)
      read (104,*,iostat=eof) LmSat(i,2,1)
      read (104,*,iostat=eof) LsucH(i,2,1)
      read (104,*,iostat=eof) Lthta(i,2,1)
      read (104,*,iostat=eof) LD_drain(i,2)
      read (104,*,iostat=eof) LN_drain(i,2)
      read (104,*,iostat=eof) LD_height(i,2)
      !Roofgarden
      read (104,*,iostat=eof) MLID_onoff(i,3)
      read (104,*,iostat=eof) LID_areaFr(i,3)
      read (104,*,iostat=eof) LID_FB(i,3)
      read (104,*,iostat=eof) LID_VoidFr(i,3)
      read (104,*,iostat=eof) Lthik(i,3,1)
      read (104,*,iostat=eof) Lksat(i,3,1)
      read (104,*,iostat=eof) LmIni(i,3,1)
      read (104,*,iostat=eof) LmSat(i,3,1)
      read (104,*,iostat=eof) LsucH(i,3,1)
      read (104,*,iostat=eof) Lthta(i,3,1)
      read (104,*,iostat=eof) Lthik(i,3,2)
      read (104,*,iostat=eof) Lksat(i,3,2)
      read (104,*,iostat=eof) LmIni(i,3,2)
      read (104,*,iostat=eof) LmSat(i,3,2)
      read (104,*,iostat=eof) LD_drain(i,3)
      read (104,*,iostat=eof) LN_drain(i,3)
      read (104,*,iostat=eof) LD_height(i,3)
      !infiltration trench
      read (104,*,iostat=eof) MLID_onoff(i,4)
      read (104,*,iostat=eof) LID_areaFr(i,4)
      read (104,*,iostat=eof) LR_fr(i,4)
      read (104,*,iostat=eof) LID_FB(i,4)
      read (104,*,iostat=eof) LID_VoidFr(i,4)
      read (104,*,iostat=eof) Lthik(i,4,1)
      read (104,*,iostat=eof) Lksat(i,4,1)
      read (104,*,iostat=eof) LmIni(i,4,1)
      read (104,*,iostat=eof) LmSat(i,4,1)
      read (104,*,iostat=eof) LsucH(i,4,1)
      read (104,*,iostat=eof) Lthta(i,4,1)
      read (104,*,iostat=eof) LD_drain(i,4)
      read (104,*,iostat=eof) LN_drain(i,4)
      read (104,*,iostat=eof) LD_height(i,4)
      !Permeable pavement
      read (104,*,iostat=eof) MLID_onoff(i,5)
      read (104,*,iostat=eof) LID_areaFr(i,5)
      read (104,*,iostat=eof) LR_fr(i,5)
      read (104,*,iostat=eof) LID_FB(i,5)
      read (104,*,iostat=eof) LID_VoidFr(i,5)
      read (104,*,iostat=eof) Lthik(i,5,1)
      read (104,*,iostat=eof) Lksat(i,5,1)
      read (104,*,iostat=eof) LmIni(i,5,1)
      read (104,*,iostat=eof) LmSat(i,5,1)
      read (104,*,iostat=eof) LsucH(i,5,1)
      read (104,*,iostat=eof) Lthta(i,5,1)
      read (104,*,iostat=eof) Lthik(i,5,2)
      read (104,*,iostat=eof) Lksat(i,5,2)
      read (104,*,iostat=eof) LmIni(i,5,2)
      read (104,*,iostat=eof) LmSat(i,5,2)
      read (104,*,iostat=eof) LsucH(i,5,2)
      read (104,*,iostat=eof) Lthta(i,5,2)
      read (104,*,iostat=eof) Lthik(i,5,4)
      read (104,*,iostat=eof) Lksat(i,5,4)
      read (104,*,iostat=eof) Lmsat(i,5,4)
      read (104,*,iostat=eof) LD_drain(i,5)
      read (104,*,iostat=eof) LN_drain(i,5)
      read (104,*,iostat=eof) LD_height(i,5)
