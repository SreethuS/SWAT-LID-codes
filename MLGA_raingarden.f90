...
subroutine MLGA_raingarden(sb,j,k,kk,lid_prec)
...
IMPLICIT NONE
 ...
 !!for the next time step
   ...
   !A_LID                |m2             |area of LID in m2
    ...
    REAL*8:: D1,phi1,D3D,h_open,h_close,A_LID,D_drain,N_drain,ET,lid_prec
    ...
    !!INTERMEDIATE!!
    REAL*8::LRAIN,inf_out,F_out,delta_t,del_t,d,F_ini
    ...
    REAL*8::layer1(5),layer2(5)!LID layer inputs
